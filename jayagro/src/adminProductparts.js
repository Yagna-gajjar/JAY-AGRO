...
export default function AdminProductparts() {
    ...
    // dotenv.config();
    // const productpart_api = process.env.REACT_APP_GETPRODUCTPART;
    // const deleteProductpart_api = process.env.
    ...
    const deleteProductpart = async (Productpartid) => {
        await axios.delete("https://jay-agro.onrender.com/deleteProductpat/" + Productpartid)
            .then((response) => {
